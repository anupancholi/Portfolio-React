...
const Services = () => {
  return (
    ...
    <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">I am an aspiring Machine Learning Engineer and Frontend Developer from Bhopal, Madhya Pradesh. With a strong foundation in programming, data science, and web development, I am actively seeking full-time opportunities where I can contribute to impactful projects, continue learning, and grow as a professional in the tech industry.</p>
    ...
    <div className="grid grid-cols-auto gap-6 my-10">
        ...
        hover:shadow-black cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 dark:hover:bg-darkHover dark:hover:shadow-white">
            ...
            <h3 className="text-lg my-4 text-gray-700 dark:text-white">Full Stack Development</h3>
        ...
        hover:shadow-black cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 dark:hover:bg-darkHover dark:hover:shadow-white">
            ...
            <h3 className="text-lg my-4 text-gray-700 dark:text-white">Machine Learning Services</h3>
            {/* <p className="text-sm text-gray-600 leading-5 dark:text-white/80">Web development is the process of building, programming...</p> */}
            {/* <a href="" className="flex items-center gap-2 text-sm mt-5">Read more <img src={right_arrow} alt="" className="w-4"/></a> */}
        </div>
        {/* <div className="border border-gray-400 rounded-lg px-8 py-12
